...
#define numTrainingSets 4
    ...
    for (int j=0; j<numHiddenNodes; j++) {
        ...
        for(int k=0; k<numInputs; k++) {
            ...
            fprintf(ptr,"%lf ",hiddenWeights[k][j]);
        }
        fputs ("] ", stdout);
        fprintf(ptr,"\n");
    }
    ...
    for (int j=0; j<numHiddenNodes; j++) {
        ...
        fprintf(ptr,"%lf ",hiddenLayerBias[j]);
    }
    fprintf(ptr,"\n");
    ...
    for (int j=0; j<numOutputs; j++) {
        ...
        for (int k=0; k<numHiddenNodes; k++) {
            ...
            fprintf (ptr,"%lf ", outputWeights[k][j]);
        }
        fprintf(ptr,"\n");
        fputs ("]\n", stdout);
    }
    ...
    for (int j=0; j<numOutputs; j++) {
        ...
        fprintf (ptr,"%lf ", outputLayerBias[j]);
